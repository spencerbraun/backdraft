...
LEGEND: dict[str, Any] = {
    ...
    "evidence": (
        ...
        "A one-page source that named itself — an HTML page's <title> — also carries "
        "`title`, which is what to call it: `filename` may be the name the fetch "
        "invented for the staging file, and the slug is a handle somebody typed. "
